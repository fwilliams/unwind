...
void make_plane(const Eigen::RowVector3d& normal, const Eigen::RowVector3d& up,
...
bool Bounding_Polygon_Menu::post_draw() {
  ...
  std::array<float, 3> ll = { PV.row(2).x(), PV.row(2).y(), PV.row(2).z() };
  std::array<float, 3> lr = { PV.row(3).x(), PV.row(3).y(), PV.row(3).z() };
  std::array<float, 3> ul = { PV.row(1).x(), PV.row(1).y(), PV.row(1).z() };
  std::array<float, 3> ur = { PV.row(0).x(), PV.row(0).y(), PV.row(0).z() };
