...
#ifdef WIN32
    strcpy(ui.folder_name, "D:/Segmentangling/Fish_Deformation/Plagiotremus-tapinosoma");
    strcpy(ui.file_prefix, "Plaagiotremus_tapinosoma_9.9um_2k__rec_Tra");
    strcpy(ui.extension, "bmp");
    ui.start_index = 2;
    ui.end_index = 1798;
    strcpy(ui.output_folder, "D:/Segmentangling/Fish_Deformation/Plagiotremus-tapinosoma-output");
