...
namespace ColorRGB {
  ...
  const Eigen::RowVector3d AQUA = Eigen::RowVector3d(0.0/255.0, 255.0/255.0, 255.0/255.0);
  const Eigen::RowVector3d FUCHSIA = Eigen::RowVector3d(255.0/255.0, 0.0/255.0, 255.0/255.0);
